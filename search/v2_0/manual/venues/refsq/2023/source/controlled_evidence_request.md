# Controlled evidence request — MSU-REFSQ-2023

- ManualSearchUnitID: `MSU-REFSQ-2023`
- CurrentEvidence: Partial Springer book page 1 with 20 local cards, validated aggregate publisher BibTeX with 25 records, and official session-level REFSQ research-track program evidence.
...
- ExpectedLocalDestination: `.local-evidence/refsq/2023/`
