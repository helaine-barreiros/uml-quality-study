...
- CurrentEvidence: complete official publisher TOC, validated publisher BibTeX, and an official partial track/session page (`SRC-REW-2025-WORKSHOPS-CROSSCHECK-HUMAN-20260814`)
- MissingEvidence: complete item-level official venue crosscheck listing all proceedings papers
- ReasonRequired: the received track/session page leaves 82 publisher research items without item-level venue confirmation
