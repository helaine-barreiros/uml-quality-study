# -*- coding: utf-8 -*-
"""Gera analysis/gate_b.html. Somente leitura sobre o CSV."""
...
CSVF = os.path.join(BASE, 'search/automated/custom_automated_search_collection.csv')
OUT = os.path.join(BASE, 'analysis/gate_b.html')
...
<footer>
Pagina gerada a partir de <code>search/automated/custom_automated_search_collection.csv</code> e da
redacao literal de <code>protocol/screening_manual_v1.md</code> e
<code>protocol/appendix_two_layer_mapping_protocol_v1_7.tex</code>. As notas de decisao do Portao B
...
PASSOS = [
    ('a1', 'B1', 'E7', 'B1_E7', 'Qual e o artefato de saida?',
     'The output is not UML, or no separable UML result is reported. This includes generic diagram '
     'generation, C4, ER, BPMN, SysML, architecture sketches, or Mermaid diagrams when no separable '
     'UML contribution is available.',
    ...
    ('a2', 'B2', 'E8', 'B2_E8', 'Quem determina o conteudo semantico do diagrama?',
     'The study does not use an LLM as a substantive component in producing, transforming, '
     'completing, repairing, refining, or revising UML diagram content.',
    ...
    ('a3', 'B3', 'E9', 'B3_E9', 'Qual e a direcao do fluxo?',
     'The task only evaluates, explains, summarizes, classifies, or discusses an existing UML '
     'diagram, without producing, transforming, completing, repairing, refining, or revising UML '
     'diagram content.',
     'So faz sentido perguntar de onde vem o conteudo depois de saber que ha um LLM em jogo. '
     'Se o LLM altera o diagrama, e I3 legitimo e o estudo segue; se apenas comenta, sai por E8.'),
    ('a4', 'B4', 'E6', 'B4_E6', 'O que entra no processo?',
     'The source input is code, an image, an existing UML model, logs, or another non-textual '
     'artifact without a substantive textual requirements or domain description component.',
...
passos_html = []
for cls, cod, ecod, key, perg, cit, porq in PASSOS:
    v = cnt[key]
    passos_html.append(
