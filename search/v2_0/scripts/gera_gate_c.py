...
Somente leitura sobre o CSV. Escreve analysis/gate_c_recuperacao.html."""
...
OUT = os.path.join(BASE, 'analysis/gate_c_recuperacao.html')
...
<footer>
Gerado a partir de <code>search/automated/custom_automated_search_collection.csv</code>.
