# -*- coding: utf-8 -*-
"""Gera analysis/gate_a.html. Somente leitura sobre o CSV.
...
OUT = os.path.join(BASE, 'analysis/gate_a.html')
...
cientifico completo. As citacoes abaixo sao a redacao literal do protocolo v1.7.</p>
...
<footer>
Pagina gerada a partir de <code>search/automated/custom_automated_search_collection.csv</code>
...
CD = [
    ('a4', 'D', 'E3', 'D_E3', 'E registro unico?',
     'The report is a duplicate or a less complete member of a publication family.',
    ...
    ('a1', 'A1', 'E4', 'A1_E4', 'O ano esta entre jan/2022 e a data da busca, e o relato esta em ingles?',
     'The report is outside the temporal or language scope of the review.',
    ...
    ('a2', 'A2', 'E1', 'A2_E1', 'E um relato cientifico completo?',
     'The item is not a complete scientific report, such as an editorial, preface, keynote, '
     'tutorial, slide deck, poster-only item, abstract-only record, thesis, book, patent, or '
     'non-scientific web content.',
    ...
    ('a3', 'A3', 'E2', 'A3_E2', 'E estudo primario?',
     'The report is a secondary or tertiary study.',
