# Controlled evidence request — MSU-REFSQ-2022

- ManualSearchUnitID: `MSU-REFSQ-2022`
- CurrentEvidence: Partial Springer book page 1 with 20 local cards, validated aggregate publisher BibTeX with 19 records, and official session-level REFSQ research-track program evidence.
...
- ExpectedLocalDestination: `.local-evidence/refsq/2022/`
