...
O BibTeX e os pacotes de PDFs controlados recebidos não definem membership. O inventário permanece somente com o cabeçalho até a aquisição do `PRIMARY_TOC` oficial.
