...
O batch documental da família MODELS é controlado por [venues/models/models_family_collection_matrix.csv](venues/models/models_family_collection_matrix.csv), auditado em [venues/models/models_family_collection_audit.md](venues/models/models_family_collection_audit.md) e utiliza, quando aplicável, as ferramentas locais documentadas em [tools/README.md](tools/README.md). O registro de um par year × track na matriz não instancia uma unidade sem identidade editorial oficial verificável.
