...
- Official proceedings URL: `https://dl.acm.org/doi/proceedings/10.1145/3550355`
...
- Expected local destination: `.local-evidence/models/2022/main/publisher_primary_toc.html` and `.local-evidence/models/2022/main/publisher_primary_toc.bib` (or the corresponding `.ris`/`.csv`).
