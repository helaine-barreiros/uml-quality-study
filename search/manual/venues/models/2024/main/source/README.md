...
Dependências: Perl e os módulos distribuídos no ambiente `Getopt::Long`, `HTML::TreeBuilder` e `Text::CSV`. O HTML de entrada é mantido em armazenamento controlado e não é versionado neste repositório. A execução deve registrar no manifest o caminho controlado, quando permitido, ou seu SHA-256 e o método de extração.
