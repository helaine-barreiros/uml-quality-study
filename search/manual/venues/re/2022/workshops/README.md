...
The complete official publisher TOC and publisher BibTeX were acquired through controlled CAPES access and reconcile at 54 records. The official independent venue crosscheck has not been received, so raw and normalized inventories remain header-only and documentary reconciliation remains blocked. No discovery or screening was performed.

- [source manifest](source/source_manifest.csv)
- [controlled evidence request](source/controlled_evidence_request.md)
- [preliminary reconciliation](source/reconciliation_report.md)
