...
The complete official publisher `PRIMARY_TOC` establishes documentary membership and has been materialized as 91 raw rows. The validated publisher BibTeX enriches the same 91 securely matched records in the normalized inventory; it does not create membership. Documentary completion and the overall reconciliation remain blocked until an independent official `VENUE_CROSSCHECK` is acquired and reconciled. No discovery or screening was performed.
