...
The complete RIS exports for S1--S4, the comparison table, and the
record-level differential classifications are retained in the replication
package. Source-specific validation of ACM Digital Library, IEEE Xplore,
...
The complete I0 implementation record and the I1--I3 CSV exports are retained in
the replication package together with the differential-record classifications.
The production IEEE Xplore retrieval will apply the protocol's temporal and
...
during production retrieval. The complete A2 and A3 EndNote exports, the
partial A1 diagnostic export, the seed-indexing check, the field-prefix
equivalence check, the differential classifications, and the diagnostic
false-negative evidence are retained in the replication package.
...
\midrule
\endhead
E1 & The item is not a complete scientific report, such as an editorial, preface, keynote summary, poster, slide deck, table of contents, or extended abstract without sufficient methods and results. \\
E2 & The study does not use an LLM or uses an LLM only for a peripheral activity that does not materially determine UML diagram content. \\
E3 & The output is not UML and no separable UML result is reported. \\
E4 & The task evaluates, explains, or summarizes an existing diagram without generating, transforming, completing, repairing, or revising it. \\
E5 & The source is code, an image, or an existing model without a substantive textual requirements or domain description component. \\
E6 & The report concerns generic diagram generation, C4, ER, BPMN, SysML, architecture sketches, or Mermaid diagrams without a separable UML contribution. \\
E7 & The report is a secondary or tertiary study. Such reports are retained separately for background and snowballing. \\
E8 & The report is a duplicate or a less complete member of a publication family. \\
E9 & The report falls outside the time or language scope. \\
E10 & The full text cannot be obtained after reasonable retrieval attempts. \\
E11 & UML generation results cannot be separated from other artifacts or tasks. \\
\bottomrule
\end{longtable}
