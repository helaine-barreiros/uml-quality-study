...
The search does not require quality terms. Requiring terms such as semantic, correctness, or hallucination at retrieval time could exclude generation studies that evaluate quality under different terminology. Extractable quality evidence is therefore assessed after retrieval through the eligibility criteria and structured full-text inspection.
...
\midrule
\endhead
I1 & The report is a complete primary scientific study within the temporal and language scope of the review. \\
I2 & The study uses at least one LLM as a substantive component of the diagram generation process. \\
I3 & The task produces, transforms, completes, repairs, refines, or revises UML diagram content. \\
I4 & The source input includes textual software requirements, user stories, scenarios, specifications, problem statements, or explicit textual domain descriptions. \\
I5 & The generated result includes explicit and separable UML diagram content, such as PlantUML code, another textual UML representation, XMI, a rendered UML diagram, or another representation from which UML content can be assessed. \\
I6 & The report provides extractable evidence about the quality, validity, correctness, completeness, consistency, pragmatic adequacy, or correction of the generated UML diagram content. \\
\bottomrule
\end{longtable}
...
E11 & The report does not provide extractable evidence about the quality, validity, correctness, completeness, consistency, pragmatic adequacy, or correction of the generated UML diagram content. \\
\bottomrule
\end{longtable}

When more than one exclusion criterion applies, the first criterion that clearly explains the exclusion is recorded. If title and abstract are insufficient to decide whether the report involves LLM-based UML generation from textual requirements or domain descriptions, the report is retained for full-text screening. The absence of explicit syntactic or semantic terminology in the title and abstract is not sufficient for exclusion when the report plausibly evaluates the generated UML output.
...
The review does not define a second eligibility layer. All included studies satisfy the same inclusion and exclusion criteria. During data extraction, each included study is classified according to the type and strength of quality evidence that it provides for the generated UML diagram content. These classifications support synthesis without redefining the eligible corpus.

The extraction classifies whether the study provides evidence about textual validity, rendering validity, UML syntactic conformity, semantic correctness, semantic completeness, consistency, pragmatic adequacy, or correction effort. It also records whether syntactic and semantic evidence are reported separately and whether the report provides direct, indirect, absent, unclear, or non-assessable evidence of syntax-semantic dissonance.
...
\begin{itemize}
    ...
    \item eligibility decision and quality-evidence classification;
...
Selection comprises calibration, title and abstract screening, full text screening, quality-evidence confirmation, and publication family reconciliation.
...
\subsection{Quality-evidence confirmation}

Extractable quality evidence is assessed independently during full-text screening under I6 and E11. When evaluation is mentioned but not sufficiently described at title and abstract, the report is retained for full-text assessment. For included reports, the type and strength of syntactic, semantic, pragmatic, and correction-related evidence are classified during extraction without creating an additional eligibility status.
...
V04 & The unified eligibility criteria and quality-evidence requirement have positive and negative examples. & \protocolfield{Pending} \\
