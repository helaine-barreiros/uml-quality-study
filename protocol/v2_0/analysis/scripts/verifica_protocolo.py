# -*- coding: utf-8 -*-
"""Travas do protocolo v2.0. Somente leitura.

Nao substitui verifica_protocolo.py, que continua verificando a v1.7. As travas
...
TEX = os.path.join(BASE, 'protocol/v2_0/appendix_two_layer_mapping_protocol_v2_0.tex')
CODEBOOK = os.path.join(BASE, 'analysis/extraction/codebook_extracao.csv')
